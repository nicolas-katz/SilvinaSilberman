...
`;function ws(){const t=()=>{document.querySelector("header").classList.toggle("open__menu")},e=()=>{document.querySelectorAll("ul li").forEach(()=>{document.querySelector("header").classList.remove("open__menu")})};return y(RL,{children:C("nav",{children:[y(qe,{to:"/",children:y("img",{src:bx,alt:"Silvina Silberman"})}),C("ul",{children:[y("li",{onClick:e,children:y(qe,{to:"/",children:"Inicio"})}),y("li",{onClick:e,children:y(qe,{to:"/about",children:"Sobre Mi"})}),y("li",{onClick:e,children:y(qe,{to:"/personal-designs",children:"Tu Dise\xF1o"})}),y("li",{onClick:e,children:y(qe,{to:"/awards",children:"Premios"})}),y("li",{onClick:e,children:y(qe,{to:"/contact",children:"Contacto"})}),C("div",{className:"data__header__mobile",children:[C("div",{children:[y("h5",{children:"Email"}),y("a",{href:"mailto:silvinasilberman@gmail.com",target:"_blank",rel:"noopener noreferrer",children:"silvinasilberman@gmail.com"})]}),C("div",{children:[y("h5",{children:"Instagram"}),y("a",{href:"https://www.instagram.com/silvisilberarte/?hl=es-la",target:"_blank",rel:"noopener noreferrer",children:"@silvisilberarte"})]})]})]}),C("div",{className:"burger__menu",onClick:t,children:[y("h4",{children:"Menu"}),C("div",{children:[y("span",{}),y("span",{})]})]})]})})}const NL=Dt.footer`
  width: 100%;
  height: max-content;
  padding: 60px 20px;
...
`;function WL(){const{logout:t,user:e,getProducts:n,createProduct:r,deleteProduct:i}=b.exports.useContext(pi),s=Ru(),[o,a]=b.exports.useState([]),[l,u]=b.exports.useState(null);b.exports.useEffect(()=>{n(a)},[]);const[c,h]=b.exports.useState(""),[d,m]=b.exports.useState(""),[g,w]=b.exports.useState(""),[x,p]=b.exports.useState(!1),[f,v]=b.exports.useState(""),[S,_]=b.exports.useState(null),[D,P]=b.exports.useState(null),O=async()=>{try{await t(),s("/")}catch(W){console.error(W.message)}},Z=W=>{const Ye=W.target.files[0],A=new FileReader;A.onloadend=function(){P(A.result.toString())},A.readAsDataURL(Ye)},B=async W=>{W.preventDefault(),await r({title:c,description:d,category:g,award:x,price:f,status:S,primaryImage:D}),h(""),m(""),w(""),v(""),p(W.target.checked=!1),_(""),P(""),u("El retrato ha sido creado con exito.")},Pe=async W=>{await i(W),u("El retrato ha sido eliminado con exito.")},Re=()=>{n(a)},ve=W=>{switch(W.preventDefault(),W.target.id){case"title":h(W.target.value);break;case"description":m(W.target.value);break;case"category":w(W.target.value);break;case"award":p(W.target.checked);break;case"price":v(W.target.value);break;case"status":_(W.target.value);break}},vt=()=>{u(null)};return C("div",{children:[y(ws,{}),C(HL,{children:[C("h1",{children:["\xA1Bienvenida, ",e==null?void 0:e.displayName,"!"]}),l&&C("div",{className:"messages__container",children:[l," ",y(ML,{onClick:vt})]}),y("h2",{children:"Publicar nuevo retrato"}),C("form",{onSubmit:B,children:[C("div",{className:"input__container",children:[y("label",{htmlFor:"title",children:"Titulo"}),y("input",{onChange:ve,type:"text",name:"title",id:"title",minLength:"3",maxLength:"20",value:c})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"description",children:"Descripci\xF3n"}),y("input",{onChange:ve,type:"text",name:"description",id:"description",minLength:"8",maxLength:"200",value:d})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"category",children:"Categor\xEDa"}),y("input",{onChange:ve,type:"text",name:"category",id:"category",minLength:"3",maxLength:"20",value:g})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"award",children:"\xBFTiene Premio?"}),y("input",{onChange:ve,type:"checkbox",name:"award",id:"award",value:x})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"price",children:"Precio (en d\xF3lares)"}),y("input",{onChange:ve,type:"number",name:"price",id:"price",min:"1",max:"1000",value:f})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"status",children:"Estado"}),C("div",{children:[y("input",{type:"radio",onChange:ve,name:"status",id:"status",value:"disponible"}),y("label",{htmlFor:"disponible",children:"Disponible"})]}),C("div",{children:[y("input",{type:"radio",onChange:ve,name:"status",id:"status",value:"vendido"}),y("label",{htmlFor:"vendido",children:"Vendido"})]})]}),C("div",{className:"input__container",children:[y("label",{htmlFor:"primaryImage",children:"Imagenes"}),y("input",{onChange:Z,type:"file",name:"primaryImage",id:"primaryImage"})]}),y("button",{type:"submit",children:"Crear retrato"})]}),y("h2",{children:"Ver, editar y/o eliminar retratos"}),y("button",{onClick:Re,children:"Recargar datos"}),y("section",{children:o&&o.map(W=>C("div",{children:[y("img",{src:W==null?void 0:W.primaryImage,alt:W==null?void 0:W.title}),C("span",{onClick:()=>Pe(W==null?void 0:W.id),children:[y("h5",{children:"Eliminar"}),y(LL,{})]})]},W.id))}),y("button",{className:"logout",onClick:O,children:"Cerrar sesi\xF3n"})]}),y(Es,{})]})}const Ho={_origin:"https://api.emailjs.com"},qL=(t,e="https://api.emailjs.com")=>{Ho._userID=t,Ho._origin=e},Px=(t,e,n)=>{if(!t)throw"The public key is required. Visit https://dashboard.emailjs.com/admin/account";if(!e)throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!n)throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates";return!0};class Av{constructor(e){this.status=e?e.status:0,this.text=e?e.responseText:"Network Error"}}const Ox=(t,e,n={})=>new Promise((r,i)=>{const s=new XMLHttpRequest;s.addEventListener("load",({target:o})=>{const a=new Av(o);a.status===200||a.text==="OK"?r(a):i(a)}),s.addEventListener("error",({target:o})=>{i(new Av(o))}),s.open("POST",Ho._origin+t,!0),Object.keys(n).forEach(o=>{s.setRequestHeader(o,n[o])}),s.send(e)}),KL=(t,e,n,r)=>{const i=r||Ho._userID;Px(i,t,e);const s={lib_version:"3.10.0",user_id:i,service_id:t,template_id:e,template_params:n};return Ox("/api/v1.0/email/send",JSON.stringify(s),{"Content-type":"application/json"})},GL=t=>{let e;if(typeof t=="string"?e=document.querySelector(t):e=t,!e||e.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of form";return e},QL=(t,e,n,r)=>{const i=r||Ho._userID,s=GL(n);Px(i,t,e);const o=new FormData(s);return o.append("lib_version","3.10.0"),o.append("service_id",t),o.append("template_id",e),o.append("user_id",i),Ox("/api/v1.0/email/send-form",o)},YL={init:qL,send:KL,sendForm:QL},XL="service_e6bwg0p",JL="template_3z9pvpj",ZL="hwH8wj1eN-3bQW7te",eM="/SilvinaSilberman/assets/contact.d1744b50.jpeg",tM=Dt.section`
    width: 100%;
    height: max-content;
    margin-top: 40px;
    padding: 40px 20px;
...
`;function nM(){const t=b.exports.useRef();return C("div",{children:[y(ws,{}),C(tM,{children:[C("div",{children:[C("div",{className:"form__information",children:[y("h1",{children:"Empezar proyecto"}),C("p",{children:["Contactame en el formulario de aqu\xED abajo para m\xE1s informaci\xF3n o v\xEDa email en ",y("a",{href:"mailto:silvinasilberman@gmail.com",children:"silvinasilberman@gmail.com"}),"."]}),C("p",{children:["Tenes un proyecto? Directamente rellena este ",y("a",{href:"",children:"formulario rapido"})," y pronto estar\xE9 en contacto con vos."]}),C("p",{children:["Tambi\xE9n podes conocer como trabajo ",y("a",{href:"/about",children:"aqu\xED"}),"."]})]}),C("form",{ref:t,onSubmit:n=>{n.preventDefault(),YL.sendForm(XL,JL,t.current,ZL).then(()=>{document.querySelector("form button").classList.add("send__mail"),document.querySelector("form button").innerHTML="ENVIADO",setTimeout(()=>{location.reload()},2500)},r=>{console.log(r.text)})},children:[C("div",{className:"row",children:[y("label",{htmlFor:"name",children:"Nombre"}),y("input",{type:"text",name:"name",id:"name",minLength:"3",maxLength:"20",required:!0})]}),C("div",{className:"row",children:[y("label",{htmlFor:"email",children:"Email"}),y("input",{type:"email",name:"email",id:"email",minLength:"6",maxLength:"40",required:!0})]}),C("div",{children:[y("label",{htmlFor:"issue",children:"Asunto"}),y("input",{type:"text",name:"issue",id:"issue",minLength:"4",maxLength:"28",required:!0})]}),C("div",{children:[y("label",{htmlFor:"message",children:"Mensaje"}),y("textarea",{type:"text",name:"message",id:"message",minLength:"4",maxLength:"200",required:!0})]}),y("button",{type:"submit",children:"Enviar"})]})]}),C("div",{children:[y("img",{src:eM,alt:"Silvina Silberman"}),y("h4",{children:"Actualmente, me encuentro trabajando en CABA pero realizo encargo a todo el pa\xEDs."})]})]}),y(Es,{})]})}const rM=Dt.section`
    width: 100%;
    height: max-content;
    margin-top: 20px;
    padding: 40px 20px;
...
`;function oM(){return C("div",{children:[y(ws,{}),C(sM,{children:[y(qe,{to:"/contact",children:"Cotizar proyecto"}),y(VL,{})]}),y(iM,{}),y(Es,{})]})}const aM=Dt.div`
    width: 100%;
    height: 100vh;
...
`;function hM(){const[t,e]=b.exports.useState(null),[n,r]=b.exports.useState(null),{productId:i}=YI(),{getProductById:s}=b.exports.useContext(pi);return b.exports.useEffect(()=>{s(e,i),r(t?null:"Los productos estan siendo cargados a la web, espere un momento.")},[i]),C("div",{children:[y(ws,{}),t?C(uM,{children:[y("img",{src:t.primaryImage,alt:t.title}),C("div",{className:"product__information",children:[C("span",{children:[y(qe,{to:"/",children:"Inicio "})," / ",y("label",{children:t.title})]}),C("h1",{children:[t.title," ",y("span",{children:t.award&&y(UL,{})})]}),C("h2",{children:[t.price," ",y("span",{children:"usd"})," ",y("h3",{className:t.status==="disponible"?"disponible":"vendido",children:t.status})]}),y("p",{children:t.description}),C("a",{className:"ask__product",href:`mailto:silvinasilberman@gmail.com?subject=Quiero encargar: ${t.title}`,children:["Comprar ",y(zL,{})]}),C("div",{className:"buyer__information",children:[C("h4",{children:[y(jL,{}),"Marco"]}),y("p",{children:"Al momento de realizar tu pedido, podr\xE1s eligir entre distintas opciones de marcos y/o portarretratos, el cu\xE1l estar\xE1 incluido en su compra."}),C("h4",{children:[y($L,{}),"Env\xEDos a domicilio"]}),y("p",{children:"Los env\xEDos a domicilio no estar\xE1n incluidos en la compra, al momento de realizar tu pedido deber\xE1s pactar la forma de intercambio con el vendedor."}),C("h4",{children:[y(OL,{}),"Formas de pago"]}),y("p",{children:"La forma de pago principal es efectivo en d\xF3lares. Sin embargo, tambi\xE9n se aceptan transferencias bancarias o mercado pago con tarjeta de credito o debito. En este ultimo caso, preguntar el tipo de cambio."})]})]})]}):C(cM,{children:[y(Dx,{}),n]}),y(Es,{})]})}const dM=Dt.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function fM({children:t}){const{user:e,loadingUser:n}=b.exports.useContext(pi);return n?y(dM,{children:y("h1",{children:"Ingresando a la cuenta de administrador..."})}):e?y("div",{children:t}):y(H1,{to:"/login"})}function pM({children:t}){const{user:e}=b.exports.useContext(pi);return e?y(H1,{to:"/admin"}):y("div",{children:t})}const mM=Dt.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function gM(){return C(mM,{children:[y("h1",{children:"404"}),y("h2",{children:"La pagina que estas buscando no existe."}),y(qe,{to:"/",children:"Volver al home"})]})}const yM=Dt.div`
    width: 100%;
...
`;function Lx(){return C(yM,{children:[y("h4",{children:"Contacto"}),C("h5",{children:["Email: ",y("a",{href:"",target:"_blank",children:"silvinasilberman@gmail.com"})]}),C("h5",{children:["Instagram: ",y("a",{href:"",target:"_blank",children:"@silvisilberarte"})]}),C(qe,{className:"contact__navlink",to:"/contact",children:["Empecemos Un Proyecto ",y(FL,{})]})]})}const vM=Dt.div`
    width: 100%;
    height: max-content;
...
`;function wM(){return C("div",{children:[y(ws,{}),C(vM,{children:[y("h1",{children:"Sobre Mi"}),C("div",{children:[C("p",{children:["Barrio Chino Est. 2017 ",y("br",{})," ",y("br",{}),"Nacido en la Cordillera de los Andes ",y("br",{})," ",y("br",{}),"Hecho en Buenos Aires ",y("br",{})," ",y("br",{}),"Cada prenda es confeccionada con materia prima de primera calidad, de manera responsable y \xE9tica en cada una de las etapas de su producci\xF3n y su impresi\xF3n. ",y("br",{})," ",y("br",{}),"Cada ser que forma parte del proceso lo hace con amor y dedicaci\xF3n."]}),y(Lx,{})]})]}),y(Es,{})]})}const EM=Dt.div`
    width: 100%;
    height: max-content;
    padding: 80px 20px 60px 20px;
...
`;function SM(){return C("div",{children:[y(ws,{}),C(EM,{children:[y("h1",{children:"Preguntas Frecuentes"}),C("div",{className:"faqs__container",children:[C("div",{children:[y("h3",{children:"\xBFCu\xE1nto se tarda en producir un retrato personalizado?"}),y("p",{children:"Easily generate Lorem Ipsum placeholder text in any number of characters, words sentences or paragraphs. Learn about the origins of the passage and its history, from the Roman era to today."})]}),C("div",{children:[y("h3",{children:"\xBFCu\xE1nto se tarda en producir un retrato personalizado?"}),y("p",{children:"Easily generate Lorem Ipsum placeholder text in any number of characters, words sentences or paragraphs. Learn about the origins of the passage and its history, from the Roman era to today."})]}),C("div",{children:[y("h3",{children:"\xBFCu\xE1nto se tarda en producir un retrato personalizado?"}),y("p",{children:"Easily generate Lorem Ipsum placeholder text in any number of characters, words sentences or paragraphs. Learn about the origins of the passage and its history, from the Roman era to today."})]})]}),y(Lx,{})]}),y(Es,{})]})}function xM(){return C(sT,{children:[y(kn,{path:"/",element:y(oM,{})}),y(kn,{path:"/about",element:y(wM,{})}),y(kn,{path:"/coleccion/:productId",element:y(hM,{})}),y(kn,{path:"/faqs",element:y(SM,{})}),y(kn,{path:"/contact",element:y(nM,{})}),y(kn,{path:"/login",element:y(pM,{children:y(lM,{})})}),y(kn,{path:"/admin",element:y(fM,{children:y(WL,{})})}),y(kn,{path:"/*",element:y(gM,{})})]})}Nh.createRoot(document.getElementById("root")).render(y(Mn.StrictMode,{children:y(cT,{children:y(bO,{children:y(xM,{})})})}));
