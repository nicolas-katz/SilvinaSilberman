 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(b,W){var P=b.length;b.push(W);e:for(;0<P;){var pe=P-1>>>1,R=b[pe];if(0<i(R,W))b[pe]=W,b[P]=R,P=pe;else break e}}function n(b){return b.length===0?null:b[0]}function r(b){if(b.length===0)return null;var W=b[0],P=b.pop();if(P!==W){b[0]=P;e:for(var pe=0,R=b.length,O=R>>>1;pe<O;){var $=2*(pe+1)-1,q=b[$],x=$+1,ne=b[x];if(0>i(q,P))x<R&&0>i(ne,q)?(b[pe]=ne,b[x]=P,pe=x):(b[pe]=q,b[$]=P,pe=$);else if(x<R&&0>i(ne,P))b[pe]=ne,b[x]=P,pe=x;else break e}}return W}function i(b,W){var P=b.sortIndex-W.sortIndex;return P!==0?P:b.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,g=!1,y=!1,w=!1,S=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(b){for(var W=n(u);W!==null;){if(W.callback===null)r(u);else if(W.startTime<=b)r(u),W.sortIndex=W.expirationTime,e(l,W);else break;W=n(u)}}function E(b){if(w=!1,v(b),!y)if(n(l)!==null)y=!0,Zt(_);else{var W=n(u);W!==null&&Qe(E,W.startTime-b)}}function _(b,W){y=!1,w&&(w=!1,p(M),M=-1),g=!0;var P=d;try{for(v(W),h=n(l);h!==null&&(!(h.expirationTime>W)||b&&!Ne());){var pe=h.callback;if(typeof pe=="function"){h.callback=null,d=h.priorityLevel;var R=pe(h.expirationTime<=W);W=t.unstable_now(),typeof R=="function"?h.callback=R:h===n(l)&&r(l),v(W)}else r(l);h=n(l)}if(h!==null)var O=!0;else{var $=n(u);$!==null&&Qe(E,$.startTime-W),O=!1}return O}finally{h=null,d=P,g=!1}}var D=!1,L=null,M=-1,J=5,H=-1;function Ne(){return!(t.unstable_now()-H<J)}function Ae(){if(L!==null){var b=t.unstable_now();H=b;var W=!0;try{W=L(!0,b)}finally{W?De():(D=!1,L=null)}}else D=!1}var De;if(typeof f=="function")De=function(){f(Ae)};else if(typeof MessageChannel<"u"){var wt=new MessageChannel,Be=wt.port2;wt.port1.onmessage=Ae,De=function(){Be.postMessage(null)}}else De=function(){S(Ae,0)};function Zt(b){L=b,D||(D=!0,De())}function Qe(b,W){M=S(function(){b(t.unstable_now())},W)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(b){b.callback=null},t.unstable_continueExecution=function(){y||g||(y=!0,Zt(_))},t.unstable_forceFrameRate=function(b){0>b||125<b?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<b?Math.floor(1e3/b):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(b){switch(d){case 1:case 2:case 3:var W=3;break;default:W=d}var P=d;d=W;try{return b()}finally{d=P}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(b,W){switch(b){case 1:case 2:case 3:case 4:case 5:break;default:b=3}var P=d;d=b;try{return W()}finally{d=P}},t.unstable_scheduleCallback=function(b,W,P){var pe=t.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?pe+P:pe):P=pe,b){case 1:var R=-1;break;case 2:R=250;break;case 5:R=1073741823;break;case 4:R=1e4;break;default:R=5e3}return R=P+R,b={id:c++,callback:W,priorityLevel:b,startTime:P,expirationTime:R,sortIndex:-1},P>pe?(b.sortIndex=P,e(u,b),n(l)===null&&b===n(u)&&(w?(p(M),M=-1):w=!0,Qe(E,P-pe))):(b.sortIndex=R,e(l,b),y||g||(y=!0,Zt(_))),b},t.unstable_shouldYield=Ne,t.unstable_wrapCallback=function(b){var W=d;return function(){var P=d;d=W;try{return b.apply(this,arguments)}finally{d=P}}}})(F0);(function(t){t.exports=F0})($0);/**
 * @license React
