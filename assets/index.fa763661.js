 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ox(t){Sn(new un("platform-logger",e=>new QC(e),"PRIVATE")),Sn(new un("heartbeat",e=>new Px(e),"PRIVATE")),qt(Td,Qg,t),qt(Td,Qg,"esm2017"),qt("fire-js","")}Ox("");var Lx="firebase",$x="9.14.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OD{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Rc(this.observer.next,e)}error(e){this.observer.error?this.Rc(this.observer.error,e):Un("Uncaught Error in snapshot listener:",e.toString())}bc(){this.muted=!0}Rc(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Po(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof hn&&Ib(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function Ib({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){B(e.idToken,"internal-error"),B(typeof e.idToken<"u","internal-error"),B(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):_b(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return B(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await Ab(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new Do;return r&&(B(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(B(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(B(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Do,this.toJSON())}_performRefresh(){return xn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eh="webStorageSupport";class s2{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=t_,this._completeRedirectFn=NO,this._overrideRedirectResult=xO}async _openPopup(e,n,r,i){var s;jn((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=uv(e,n,r,Zd(),i);return e2(e,o,pm())}async _openRedirect(e,n,r,i){return await this._originValidation(e),oO(uv(e,n,r,Zd(),i)),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(jn(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await GO(e),r=new DO(e);return n.register("authEvent",i=>(B(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Eh,{type:Eh},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Eh];o!==void 0&&n(!!o),cn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=MO(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return qE()||hm()||nc()}}const o2=s2;var cv="@firebase/auth",hv="0.20.11";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function VL(){const t=N.exports.useRef();return se("div",{children:[E(__,{}),se(FL,{children:[se("div",{children:[se("div",{className:"form__information",children:[E("h1",{children:"Empezar proyecto"}),se("p",{children:["Feel free to get in touch with me via the form below or by emailing me directly at ",E("a",{href:"mailto:silvinasilberman@gmail.com",children:"silvinasilberman@gmail.com"}),"."]}),se("p",{children:["Have a project? Skip directly to the ",E("a",{href:"",children:"intake form"})," and I\u2019ll be in touch!"]}),E("p",{children:"You may find an answer to your question in the FAQs."})]}),se("form",{ref:t,onSubmit:n=>{n.preventDefault(),LL.sendForm($L,ML,t.current,UL).then(()=>{document.querySelector("form button").classList.add("send__mail"),document.querySelector("form button").innerHTML="ENVIADO",setTimeout(()=>{location.reload()},2500)},r=>{console.log(r.text)})},children:[se("div",{className:"row",children:[E("label",{htmlFor:"name",children:"Nombre"}),E("input",{type:"text",name:"name",id:"name",minLength:"3",maxLength:"20",required:!0})]}),se("div",{className:"row",children:[E("label",{htmlFor:"email",children:"Email"}),E("input",{type:"email",name:"email",id:"email",minLength:"6",maxLength:"40",required:!0})]}),se("div",{children:[E("label",{htmlFor:"issue",children:"Asunto"}),E("input",{type:"text",name:"issue",id:"issue",minLength:"4",maxLength:"28",required:!0})]}),se("div",{children:[E("label",{htmlFor:"message",children:"Mensaje"}),E("textarea",{type:"text",name:"message",id:"message",minLength:"4",maxLength:"200",required:!0})]}),E("button",{type:"submit",children:"Enviar"})]})]}),se("div",{children:[E("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d210147.47495907973!2d-58.59811024378054!3d-34.615430352723926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcca3b4ef90cbd%3A0xa0b3812e88e88e87!2sBuenos%20Aires%2C%20CABA!5e0!3m2!1ses-419!2sar!4v1670715467660!5m2!1ses-419!2sar",width:"400",height:"300",allowFullScreen:"",referrerPolicy:"no-referrer-when-downgrade"}),se("h4",{children:["Buenos Aires, ",E("span",{children:"Argentina."})]})]})]}),E(C_,{})]})}const pe="/SilvinaSilberman/assets/main.c223110a.jpg",jL=Tc.section`
    width: 100%;
    height: max-content;
    padding: 40px 20px;
...
`;function zL(){const{products:t}=N.exports.useContext(fs),[e,n]=N.exports.useState([]),r=i=>{const s=i.target.name;switch(s){case"all":n(t),document.querySelectorAll("button").forEach(o=>o.classList.remove("active")),i.target.classList.add("active");break;case"birome":n(t.filter(o=>o.category===s)),document.querySelectorAll("button").forEach(o=>o.classList.remove("active")),i.target.classList.add("active");break;case"color":n(t.filter(o=>o.category===s)),document.querySelectorAll("button").forEach(o=>o.classList.remove("active")),i.target.classList.add("active");break}};return se(jL,{children:[se("div",{className:"filters",children:[E("button",{className:"active",name:"all",onClick:r,children:"Todos"}),E("button",{name:"birome",onClick:r,children:"Birome"}),E("button",{name:"color",onClick:r,children:"Color"}),E("button",{name:"color",onClick:r,children:"Black & White"}),E("button",{name:"color",onClick:r,children:"Famosos"}),E("button",{name:"color",onClick:r,children:"Clasicos"})]}),se("div",{className:"portfolio",children:[E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"}),E("img",{src:pe,alt:"Silvina Silberman - Portfolio"})]})]})}function BL(){return se("div",{children:[E(__,{}),E(zL,{}),E(C_,{})]})}function HL(){const{loginAdminUser:t,setIsLogged:e}=N.exports.useContext(fs),n=sp(),[r,i]=N.exports.useState({email:"",password:""}),[s,o]=N.exports.useState(""),a=({target:{name:u,value:c}})=>{i({...r,[u]:c})};return se("form",{onSubmit:async u=>{u.preventDefault(),o("");try{r.email===tf?(await t(r.email,r.password),e(!0),n("/admin")):o("El correo ingresado no es del administrador.")}catch(c){switch(c.message){case"email-invalid":o("Correo invalido. Por favor revisa los campos.");break;case"user-not-found":o("Correo inexistente. Por favor revisa los campos.");break;case"wrong-password":o("Contrase\xF1a erronea. Por favor revisa los campos.");break;default:o("Ocurrio un error. Por favor vuelve a intentarlo.");break}}},children:[E("input",{onChange:a,type:"email",name:"email",id:"email",minLength:"6",maxLength:"40",placeholder:"Ingresa tu correo electronico.",required:!0}),E("input",{onChange:a,type:"password",name:"password",id:"password",minLength:"6",maxLength:"40",placeholder:"Ingresa tu contrase\xF1a.",required:!0}),E("button",{type:"submit",children:"Iniciar sesi\xF3n"}),s&&E("h1",{children:s})]})}function WL(){const[t,e]=N.exports.useState({}),{productId:n}=BT(),{products:r}=N.exports.useContext(fs);return N.exports.useEffect(()=>{e(r.find(i=>i.id===n))},[r]),E("div",{children:E("div",{children:se("h1",{children:[t.title," (",t.description,")"]})})})}function Cv({children:t}){const{user:e,loading:n}=N.exports.useContext(fs),r=sp();return n?E("h1",{children:"Cargando..."}):e?e?r("/admin"):E("div",{children:t}):r("/login")}function qL(){const{createAdminUser:t,userEmail:e}=N.exports.useContext(fs);return N.exports.useEffect(()=>{(async()=>{try{if(e==tf)return await t(tf,I2)}catch(r){console.error(r.message)}})()},[]),se(JT,{children:[E(pi,{path:"/",element:E(BL,{})}),E(pi,{path:"/coleccion/:productId",element:E(WL,{})}),E(pi,{path:"/contact",element:E(VL,{})}),E(pi,{path:"/login",element:E(Cv,{children:E(HL,{})})}),E(pi,{path:"/admin",element:E(Cv,{children:E(k2,{})})})]})}Ch.createRoot(document.getElementById("root")).render(E(Dn.StrictMode,{children:E(rC,{children:E(_2,{children:E(qL,{})})})}));
