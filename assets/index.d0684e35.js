 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jC(t){_n(new dn("platform-logger",e=>new nC(e),"PRIVATE")),_n(new dn("heartbeat",e=>new FC(e),"PRIVATE")),Kt(Nd,Zg,t),Kt(Nd,Zg,"esm2017"),Kt("fire-js","")}jC("");var VC="firebase",BC="9.14.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kt(VC,BC,"app");const aw="@firebase/installations",dp="0.5.16";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kw="installations",I2="installations-internal",T2=t=>{const e=t.getProvider("app").getImmediate(),n=k2(e),r=fi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},C2=t=>{const e=t.getProvider("app").getImmediate(),n=fi(e,kw).getImmediate();return{getId:()=>E2(n),getToken:i=>S2(n,i)}};function A2(){_n(new dn(kw,T2,"PUBLIC")),_n(new dn(I2,C2,"PRIVATE"))}A2();Kt(aw,dp);Kt(aw,dp,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function sM(){const{getProducts:t}=I.exports.useContext(Lr),[e,n]=I.exports.useState(null),[r,i]=I.exports.useState(null);return I.exports.useEffect(()=>{t(n),!e||(e==null?void 0:e.length)<0?i("Los productos estan siendo cargados a la web, espere un momento o vuelva a intentarlo m\xE1s tarde."):i(null)},[]),k(iM,{children:[m("h1",{children:"Portfolio"}),m("div",{className:"portfolio",id:"portfolio",children:(e==null?void 0:e.length)>0&&e?e.map(s=>m(tt,{to:`/colection/${s.id}`,children:m("img",{src:s.images,alt:s.title})},s.id)):m("div",{className:"error__messages",children:k("div",{children:[m(PS,{}),r]})})})]})}const oM=vt.main`
  position: relative;
...
`;function aM(){return I.exports.useEffect(()=>{window.scroll({top:0,left:0,behavior:"smooth"})},[]),k("div",{children:[m(Gn,{}),k(oM,{children:[m(tt,{to:"/contact",children:"Cotizar proyecto"}),m(BL,{})]}),m(sM,{}),m(Qn,{})]})}const lM=vt.div`
    width: 100%;
...
`;function dM(){const[t,e]=I.exports.useState(null),[n,r]=I.exports.useState(null),{productId:i}=YI(),{getProductById:s}=I.exports.useContext(Lr);return I.exports.useEffect(()=>{window.scroll({top:0,left:0,behavior:"smooth"})},[]),I.exports.useEffect(()=>{s(e,i),r(t?null:"Los productos estan siendo cargados a la web, espere un momento.")},[i]),k("div",{children:[m(Gn,{}),t?k(cM,{children:[m("img",{src:t.images,alt:t.title}),k("div",{className:"product__information",children:[k("span",{children:[m(tt,{to:"/",children:"Inicio "})," / ",m("label",{children:t.title})]}),k("h1",{children:[t.title," ",m("span",{children:t.award&&m(zL,{})})]}),k("h2",{children:[t.price," ",m("span",{children:"usd"})," ",m("h3",{className:t.status==="disponible"?"disponible":"vendido",children:t.status})]}),m("p",{children:t.description}),k("a",{className:"ask__product",href:`mailto:silvinasilberman@gmail.com?subject=Quiero encargar: ${t.title}`,children:["Comprar ",m(jL,{})]}),k("div",{className:"buyer__information",children:[k("h4",{children:[m(VL,{}),"Marco"]}),m("p",{children:"Al momento de realizar tu pedido, podr\xE1s eligir entre distintas opciones de marcos y/o portarretratos, el cu\xE1l estar\xE1 incluido en su compra."}),k("h4",{children:[m(FL,{}),"Env\xEDos a domicilio"]}),m("p",{children:"Los env\xEDos a domicilio no estar\xE1n incluidos en la compra, al momento de realizar tu pedido deber\xE1s pactar la forma de intercambio con el vendedor."}),k("h4",{children:[m(OL,{}),"Formas de pago"]}),m("p",{children:"La forma de pago principal es efectivo en d\xF3lares. Sin embargo, tambi\xE9n se aceptan transferencias bancarias o mercado pago con tarjeta de credito o debito. En este ultimo caso, preguntar el tipo de cambio."})]})]})]}):k(hM,{children:[m(PS,{}),n]}),m(Qn,{})]})}const fM=vt.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function pM({children:t}){const{user:e,loadingUser:n}=I.exports.useContext(Lr);return n?m(fM,{children:m("h1",{children:"Ingresando a la cuenta de administrador..."})}):e?m("div",{children:t}):m(W1,{to:"/login"})}function mM({children:t}){const{user:e}=I.exports.useContext(Lr);return e?m(W1,{to:"/admin"}):m("div",{children:t})}const gM=vt.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function yM(){return k(gM,{children:[m("h1",{children:"404"}),m("h2",{children:"La pagina que estas buscando no existe."}),m(tt,{to:"/",children:"Volver al home"})]})}const vM=vt.div`
    width: 100%;
...
`;function MS(){return k(vM,{children:[m("h4",{children:"Contacto"}),k("h5",{children:["Email: ",m("a",{href:"",target:"_blank",children:"silvinasilberman@gmail.com"})]}),k("h5",{children:["Instagram: ",m("a",{href:"",target:"_blank",children:"@silvisilberarte"})]}),k(tt,{className:"contact__navlink",to:"/contact",children:["Empecemos Un Proyecto ",m(UL,{})]})]})}const wM=vt.div`
    width: 100%;
    height: max-content;
...
`;function xM(){return I.exports.useEffect(()=>{window.scroll({top:0,left:0,behavior:"smooth"})},[]),k("div",{children:[m(Gn,{}),k(wM,{children:[m("h1",{children:"Sobre Mi"}),k("div",{children:[k("p",{children:["Barrio Chino Est. 2017 ",m("br",{})," ",m("br",{}),"Nacido en la Cordillera de los Andes ",m("br",{})," ",m("br",{}),"Hecho en Buenos Aires ",m("br",{})," ",m("br",{}),"Cada prenda es confeccionada con materia prima de primera calidad, de manera responsable y \xE9tica en cada una de las etapas de su producci\xF3n y su impresi\xF3n. ",m("br",{})," ",m("br",{}),"Cada ser que forma parte del proceso lo hace con amor y dedicaci\xF3n."]}),m(MS,{})]})]}),m(Qn,{})]})}const EM=vt.div`
    width: 100%;
    height: max-content;
    padding: 80px 20px 60px 20px;
...
`;function CM(){return I.exports.useEffect(()=>{window.scroll({top:0,left:0,behavior:"smooth"})},[]),k("div",{children:[m(Gn,{}),k(TM,{children:[m("h1",{children:"Premios"}),k("div",{className:"awards__container",children:[k("div",{className:"awards__box",children:[m("img",{src:_M,alt:"Silvina Silberman"}),m("a",{children:"Ver Publicaci\xF3n"})]}),k("div",{className:"awards__box",children:[m("img",{src:kM,alt:"Silvina Silberman"}),m("a",{children:"Ver Publicaci\xF3n"})]}),k("div",{className:"awards__box",children:[m("img",{src:IM,alt:"Silvina Silberman"}),m("a",{children:"Ver Publicaci\xF3n"})]})]})]}),m(Qn,{})]})}const AM=vt.div`
    width: 100%;
    height: max-content;
    padding: 80px 20px 60px 20px;
...
`;function bM(){I.exports.useEffect(()=>{window.scroll({top:0,left:0,behavior:"smooth"})},[]);const{getProducts:t}=I.exports.useContext(Lr),[e,n]=I.exports.useState(null),[r,i]=I.exports.useState(null);return I.exports.useEffect(()=>{t(n),e&&e.forEach((s,o)=>{o<=7&&i(...r,s.title)}),r&&console.log(r)},[]),k("div",{children:[m(Gn,{}),m(AM,{children:m("h1",{children:"Eleg\xED Tu Pr\xF3ximo Retrato"})}),m(Qn,{})]})}function RM(){return k(sT,{children:[m(rn,{path:"/",element:m(aM,{})}),m(rn,{path:"/about",element:m(xM,{})}),m(rn,{path:"/designs",element:m(bM,{})}),m(rn,{path:"/awards",element:m(CM,{})}),m(rn,{path:"/colection/:productId",element:m(dM,{})}),m(rn,{path:"/faqs",element:m(SM,{})}),m(rn,{path:"/contact",element:m(rM,{})}),m(rn,{path:"/login",element:m(mM,{children:m(uM,{})})}),m(rn,{path:"/admin",element:m(pM,{children:m(qL,{})})}),m(rn,{path:"/*",element:m(yM,{})})]})}Dh.createRoot(document.getElementById("root")).render(m(Mn.StrictMode,{children:m(cT,{children:m(bO,{children:m(RM,{})})})}));
